...
export const Privacy = () => (
  ...
  >
    ...
    <Text>
      We collect data to provide the best hotel booking services to all our
      users. This data includes name, email, booking details, and usage
      patterns.
    </Text>
    <Text>
    ...
    <Text>
      ...
      at privacy@hotelbookingapp.com.
    </Text>
  </Stack>
);
...
export const Help = () => (
  ...
  >
    ...
    <Text>
      You can reach our support team at support@hotelbookingapp.com or call us
      at (123) 456-7890. We are available from 9 AM to 6 PM, Monday to Friday.
    </Text>
    <Text>Thank you for using our service. We are here to help you!</Text>
  </Stack>
);
...
export const Policy = () => (
  ...
  >
    ...
    <Text>
      Welcome to our Terms & Conditions section. By using our hotel booking
    ...
    <Text>
      All bookings are subject to availability and may be subject to further
    ...
    <Text>
      ...
      contact us at policy@hotelbookingapp.com.
    </Text>
  </Stack>
);
